...
import post1 from '../assests/images/post-image1.jpg'
import post2 from '../assests/images/post-item2.jpg'
import post3 from '../assests/images/post-item3.jpg'
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image set">
                  <img src={post2} alt="" class="img-fluid"/>
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image set">
                  <img src={post3} alt="" class="img-fluid"/>
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
